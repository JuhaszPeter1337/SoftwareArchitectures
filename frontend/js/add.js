async function sendEvent(){
    ...
    var interests1 = document.getElementById("i1").checked;
    var interests2 = document.getElementById("i2").checked;
    var interests3 = document.getElementById("i3").checked;
    var interests4 = document.getElementById("i4").checked;
    var interests5 = document.getElementById("i5").checked;
    var interests6 = document.getElementById("i6").checked;
